...
public class Point implements Comparable<Point> {
     ...
     *         argument point
     */
    public int compareTo(Point that) { // this is y0, that is y1

//        if (that.y  > this.y) // if y1 > y0
//            return -1;
//        else if(that.y == this.y && that.x > this.x) // or if y1 = y0 and x1 > x0, return less than (-1)
//            return -1;
